...
void GcodeSuite::M421() {
  ...
  else if (!WITHIN(ij.x, 0, TERN(DYNAMIC_LEVELING, GRID_USED_POINTS_X, GRID_MAX_POINTS_X) - 1) || !WITHIN(ij.y, 0, TERN(DYNAMIC_LEVELING, GRID_USED_POINTS_Y, GRID_MAX_POINTS_Y) - 1))
