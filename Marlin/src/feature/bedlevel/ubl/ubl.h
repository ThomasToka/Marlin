...
public:
   ...
   */
  static float z_correction_for_x_on_horizontal_mesh_line(const float rx0, const uint8_t x1_i, const uint8_t yi OPTARG(DYNAMIC_LEVELING, const xy_uint8_t& _max_points)) {
  ...
  //
  static float z_correction_for_y_on_vertical_mesh_line(const float ry0, const uint8_t xi, const uint8_t y1_i OPTARG(DYNAMIC_LEVELING, const xy_uint8_t& _max_points)) {
